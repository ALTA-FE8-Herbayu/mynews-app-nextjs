...
const CardNews = ({ title, imageUrl, author, date, klik }) => {
    return (
        <div className="h-auto m-2 rounded bg-violet-50 w-60">
            ...
            <p className="text-center text-black">Date :{date}</p>
            <div className="flex justify-center pb-2 mt-2 text-white">
                <button onClick={klik} className="px-2 italic font-bold text-white rounded-full bg-gradient-to-r from-orange-500 to-teal-500">
                    Read More
                </button>
            </div>
        </div>
