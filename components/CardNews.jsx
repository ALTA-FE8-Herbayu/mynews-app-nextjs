...
const CardNews = ({ title, imageUrl, author, date, klik }) => {
    return (
        <div className="m-4 border-2 rounded-lg h-[450px] border-teal-400 w-60 backdrop-blur bg-transparent">
            <h1 className="my-2 font-bold text-center text-black">{title}</h1>
            <Image unoptimized={true} className="absolute w-full h-52" src={imageUrl} alt={author} width={500} height={500} />
